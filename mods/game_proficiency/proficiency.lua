...
function init()
	...
	Keybind.new("Windows", "Show/hide weapon proficiency window", "Ctrl+M", "")
	Keybind.bind("Windows", "Show/hide weapon proficiency window", {
		{
			type = KEY_DOWN,
			callback = toggle,
		}
...
function toggle()
	if WeaponProficiency.window:isVisible() then
		...
		-- Se ainda nao solicitou os dados, chamar requestOpenWindow
